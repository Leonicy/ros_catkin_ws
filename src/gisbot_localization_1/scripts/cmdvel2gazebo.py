...
class CmdVel2Gazebo:
    def __init__(self):
        ...
        rospy.Subscriber('/my_car/cmd_vel', Twist, self.callback, queue_size=1)
        self.pub_steerL = rospy.Publisher('/my_car/front_left_wheel_joint_position_controller/command', Float64, queue_size=1)
        self.pub_steerR = rospy.Publisher('/my_car/front_right_wheel_joint_position_controller/command', Float64, queue_size=1)
        self.pub_rearL = rospy.Publisher('/my_car/back_left_wheel_velocity_controller/command', Float64, queue_size=1)
        self.pub_rearR = rospy.Publisher('/my_car/back_right_wheel_velocity_controller/command', Float64, queue_size=1)
